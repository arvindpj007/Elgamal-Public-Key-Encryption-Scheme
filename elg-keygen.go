...
func missingParametersError() {
	...
	fmt.Println("HELP:")
	fmt.Println("./elg-keygen <filename to store public key> <filename to store secret key>")
...
func main() {
	...
	var filePublicKey string
	var filePublicKeyText string
	var fileSecretKey string
	var fileSecretKeyText string

	filePublicKey, fileSecretKey = setupCLI()
	...
	filePublicKeyText = getTextFromInts(P, G, Ga)
	fileSecretKeyText = getTextFromInts(P, G, A)

	// fmt.Println("fileBobText: ", fileBobText)
	// fmt.Println("secretKeyAlice: ", secretKeyAliceText)

	setOutputText(filePublicKeyText, filePublicKey)
	setOutputText(fileSecretKeyText, fileSecretKey)
